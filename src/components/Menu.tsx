  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log('🔍 Checking image URLs:', menuData?.map(item => ({ id: item.id, name: item.name, image_url: item.image_url })));
          ...
          >
            <div className="bg-gradient-to-r from-slate-50 via-blue-50 to-indigo-50 border border-slate-200/60 rounded-2xl p-6 shadow-sm backdrop-blur-sm max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
                ...
                <a
                  href="https://www.ubereats.com/ca/store/howdy-cafe-700-midnight-dr-104/U4H9D3jiTgKf3Z_BDfyMeA"
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            {filteredMenuItems.map((item) => (
              ...
              >
                <div className="relative">
                  ...
                  <div className="image-fallback absolute inset-0 bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center hidden">
